...
import TreasurerHomeScreen from "./TreasurerHomeScreen";
...
const TreasurerSignIn = ({ navigation }) => {
	...
	const handlePress = () => {
		...
		if (
			userName.substring(0, 2).toUpperCase() === "TR" &&
			password.length > 7
		) {
			...
			navigation.navigate("TryAgainCreatingAcc", {
				err: "Password entered was incorrect",
				msg: "You are not logged in.",
			});
		} else {
	...
	return (
		<ScrollView contentContainerStyle={styles.scrollViewContent}>
			<View style={styles.container}>
				...
				<Image
					source={{
						uri: "https://i.gyazo.com/415495daadaf485604315667fec8fad1.png",
					}}
					style={styles.logo}
				/>
				...
				<View style={styles.topContent}>
					<Text style={styles.heading}>
						We're glad you're back Treasurer...
					</Text>
				</View>
				...
				<View style={styles.formContainer}>
					...
					<TouchableHighlight
						...
						activeOpacity={0.7}
						onPress={() => [
							navigation.navigate("MemberCreateAccount"),
						]}
					>
